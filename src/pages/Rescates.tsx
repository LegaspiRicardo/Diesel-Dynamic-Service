...
export default function Rescates() {
    return (
        <section>
                ...
                <div className="max-w-6xl mx-auto px-6 ">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="text-center p-6">
                            ...
                            <p className="text-gray-600">Nos contacta proporcionando ubicación y detalles</p>
                        </div>
                        <div className="text-center p-6">
                            ...
                            <p className="text-gray-600">Enviamos un mecánico cercana a su ubicación </p>
                        </div>
                        <div className="text-center p-6">
            ...
            {/* Rescate URGENTE */}
            <div className="bg-red-800/90 py-16 ">
            ...
            <div className="md:w-11/12 md:mx-auto py-16">
                <div className="bg-white rounded-lg shadow-lg p-8 max-w-6xl mx-auto px-6 ">
