...
export default function Contacto() {
    return (
        <div className="min-h-screen bg-gray-50 ">
            ...
            <div
                className="relative bg-cover bg-center bg-no-repeat text-white py-16 lg:py-20"
                style={{ backgroundImage: "url('images/ddsfotos/equipoDDS.jpg')" }}
            >
                {/* Overlay ajustable para balance perfecto */}
                ...
                <div className="relative w-11/12 mx-auto px-6 text-center  z-10">
                    ...
                    <p className="text-xl md:text-2xl lg:text-3xl font-semibold my-4 max-w-2xl mx-auto drop-shadow-md leading-tight">
                        y reciba atención personalizada
                    </p>
